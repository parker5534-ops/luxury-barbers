    ...
    <footer className="footer" style={{ paddingBottom: 80 }}>
      <div className="footer-inner">
        ...
        <div>
          ...
          <div className="footer-links-list">
            {['services', 'gallery', 'about', 'faq', 'contact'].map((p) => (
              <a key={p} onClick={() => navigate(p)} style={{ textTransform: 'capitalize' }}>
                {p}
              </a>
            ))}
          </div>
        ...
        <div>
          ...
          <button className="btn-primary" style={{ marginTop: 24 }} onClick={onBook}>
            Book Now →
          </button>
        </div>
      </div>
